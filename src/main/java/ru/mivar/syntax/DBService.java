...
//import ru.mivar.syntax.dbService.ru.mivar.syntax.dao.UsersDAO;
//import ru.mivar.syntax.dbService.ru.mivar.syntax.dataSets.UsersDataSet;
...
import ru.mivar.syntax.resource.DBConnection;
...
//            UsersDAO ru.mivar.syntax.dao = new UsersDAO(session);
//            UsersDataSet dataSet = ru.mivar.syntax.dao.get(id);
//            session.close();
//            return dataSet;
...
//            Session session = sessionFactory.openSession();
//            UsersDAO ru.mivar.syntax.dao = new UsersDAO(session);
//            UsersDataSet dataSet = ru.mivar.syntax.dao.get(name, pass);
//            session.close();
//            return dataSet;
//        } catch (HibernateException e) {
//            throw new DBException(e);
...
//            UsersDAO ru.mivar.syntax.dao = new UsersDAO(session);
//            long id = ru.mivar.syntax.dao.insertUser(name, pass);
//            transaction.commit();
//            session.close();
//            return id;
//        } catch (HibernateException e) {
