...
//        String testText = "Папа и папа пошел в лес. Он там увидел грибы. Папа и папа пошел в лес. Папа и папа пошел в лес.";
        String testText = "Голодная волчиха встала, чтобы идти на охоту. Ее волчата, все трое, крепко спали, сбившись в кучу, и грели друг друга. Она облизала их и пошла.\n" +
        ...
        SyntaxGraphBuilder.buildPlainGraph(testText, DBService.getConnection());
    }
